...
results as a diagnosis. For any such request, politely refuse briefly and say that
the user should consult a qualified healthcare professional. You may provide
general, non-personalized educational information about medical topics.
""".strip()
